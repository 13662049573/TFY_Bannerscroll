...
@interface TFY_PresentTransition ()
...
@implementation TFY_PresentTransition
...
- (void)presentAnimation:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    toVC.view.alpha = 1;
    [self.delagate tfy_orientationWillChange:YES];
    ...
    [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
        ...
        [self.delagate tfy_orientationDidChanged:YES];
