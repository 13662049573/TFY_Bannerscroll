...
- (void)prepareLayout
{
    ...
    CGSizeMake(self.param.tfy_ItemSize.width , self.param.tfy_ItemSize.height - (visibleItemsCount - 1)*self.param.tfy_LineSpacing):
    CGSizeMake(self.param.tfy_ItemSize.width - (visibleItemsCount - 1)*self.param.tfy_LineSpacing, self.param.tfy_ItemSize.height);
    self.minimumInteritemSpacing = (self.param.tfy_Frame.size.height-self.param.tfy_ItemSize.height)/2;
    self.minimumLineSpacing = self.param.tfy_Vertical?
